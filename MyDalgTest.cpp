...
BOOL CMyDalgTestApp::InitInstance()
{
	...
	try
	{
		...
		m_PConn->ConnectionString = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=E:\\VS程序\\C++ project\\MyDalgTest\\MyDalgTest\\juxian.accdb";
